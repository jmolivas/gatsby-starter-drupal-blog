...
import './style.scss';
import Button from 'gatsby-theme-drupal-blog/src/components/atoms/button';
        ...
        <div className="c-header__scrolled grid-x align-middle">
          <div className="cell grid-container grid-x align-middle">
            <Link to="/" className="c-header__logo__link">
              <svg className="c-header__logo" width="200" height="60" viewBox="0 0 480 180" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fillRule="evenodd">
                  ...
                  <g fillRule="nonzero">
                    <g fill="#FFF"><path d="M463.494 90h-44.745v12.808h30.682c-4.474 19.213-18.537 35.224-37.074 41.628l-73.51-73.649c7.671-22.415 29.404-38.425 54.334-38.425 19.176 0 36.435 9.606 47.301 24.336l9.588-8.326c-12.784-17.291-33.239-28.819-56.89-28.819-33.238 0-61.363 23.696-68.395 55.077l84.376 84.536c30.682-7.685 54.333-35.864 54.333-69.166zM322.868 90.64c0 17.932 7.03 35.224 20.454 48.673 13.424 13.449 31.322 20.493 48.58 20.493L322.868 90.64z" /></g>
                    <path d="M393.18.34c-49.218 0-89.489 40.347-89.489 89.66 0 49.313 40.27 89.66 89.49 89.66 49.219 0 89.49-40.347 89.49-89.66C482.67 40.687 442.4.34 393.18.34zm-49.858 139.613c-13.423-13.449-20.454-31.38-20.454-48.672l69.673 69.166c-17.897-.64-35.795-7.045-49.219-20.494zm65.2 18.572L324.785 74.63c7.032-31.381 35.157-55.077 68.396-55.077 23.65 0 44.105 11.528 56.89 28.82l-9.589 8.325c-10.866-14.73-28.125-24.336-47.301-24.336-24.93 0-46.023 16.01-54.333 38.425l73.509 73.65c18.537-6.405 32.6-22.416 37.074-41.629H418.75V90h44.745c0 33.302-23.651 61.48-54.972 68.525z" fill="#639" />
                  </g>
                  <path d="M274 143h-17.853l-40.592-32.34 34.597-33.319L274 96.854V143" />
                  <path d="M248.147 76a15.158 15.158 0 0 0-7.363-1.896c-4.722 0-8.94 2.15-11.73 5.532v41.068s23.6-14.845 26.223-26.625c.485-1.476.756-3.055.756-4.7 0-5.763-3.182-10.763-7.886-13.379" fill="#A0283A" />
                  <path d="M217.295 74.104c-2.66 0-5.16.69-7.353 1.896-4.704 2.607-7.886 7.616-7.886 13.379 0 1.645.27 3.224.756 4.7 2.613 11.78 26.242 26.625 26.242 26.625V79.636c-2.81-3.382-7.027-5.532-11.759-5.532" fill="#CC3C4C" />
                </g>
